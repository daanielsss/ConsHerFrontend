        ...
        <div className="bg-background">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
                ...
                <section className="mt-16 bg-slate-100 dark:bg-slate-800 p-8 rounded-lg text-center">
                    ...
                    <a href="https://wa.me/523312345678?text=Hola,%20me%20interesa%20la%20propiedad:%20'${house.title}'" target="_blank" rel="noopener noreferrer" className="mt-6 inline-block bg-primary text-primary-foreground font-semibold px-8 py-3 rounded-lg shadow-lg hover:bg-primary/90 transition-transform hover:scale-105">
                        Contactar Ahora
                    </a>
