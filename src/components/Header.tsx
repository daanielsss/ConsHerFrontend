...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-background border-b-2 border-primary py-4 px-4 pl-[4.5rem] md:pl-[14rem] transition-all duration-300 flex justify-between items-center">
